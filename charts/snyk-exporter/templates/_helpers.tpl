...
{{/*
Create chart label value used as a selector label.
*/}}
...
{{/*
Name of the secret containing the Snyk API token
*/}}
{{- define "snyk-exporter.secretName" -}}
{{- if .Values.snyk.existingSecret }}
{{- .Values.snyk.existingSecret }}
{{- else }}
{{- include "snyk-exporter.fullname" . }}
{{- end }}
{{- end }}
